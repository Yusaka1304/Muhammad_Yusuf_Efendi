...
<body>  
    ...
    <!-- Cafe Menu -->
    <!-- <div id="menu" class="parallax-window" data-parallax="scroll" data-image-src="img/mie5.jpg">
        <div class="container mx-auto tm-container py-24 sm:py-48">
            <div class="text-center mb-16">
                <h2 class="bg-white tm-text-brown py-6 px-12 text-4xl font-medium inline-block rounded-md">Our Noodle Menu</h2>
            </div>            
            <div class="flex flex-col lg:flex-row justify-around items-center">
                <div class="flex-1 m-5 rounded-xl px-4 py-6 sm:px-8 sm:py-10 tm-bg-brown tm-item-container">
                    <div class="flex items-start mb-6 tm-menu-item">
                        <img src="img/menu-mie1.jpg" alt="Image" class="rounded-md">
                        <div class="ml-3 sm:ml-6">
                            <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow">Indomie</h3>
                            <div class="text-white text-md sm:text-lg font-light mb-1">Mie goreng</div>
                            <div class="text-white text-md sm:text-lg font-light">Rp.44.000</div>
                        </div>                    
                    </div>
                    <div class="flex items-start mb-6 tm-menu-item">
                        <img src="img/menu-mie1.jpg" alt="Image" class="rounded-md">
                        <div class="ml-3 sm:ml-6">
                            <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow">Indomie</h3>
                            <div class="text-white text-md sm:text-lg font-light mb-1">Mie goreng</div>
                            <div class="text-white text-md sm:text-lg font-light">Rp.100000</div>
                        </div>                    
                    </div>
                    <div class="flex items-start mb-6 tm-menu-item">
                        <img src="img/menu-mie1.jpg" alt="Image" class="rounded-md">
                        <div class="ml-3 sm:ml-6">
                            <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow">Indomie</h3>
                            <div class="text-white text-md sm:text-lg font-light mb-1">miee gorengg</div>
                            <div class="text-white text-md sm:text-lg font-light">Rp.3000</div>
                        </div>                    
                    </div>
                    <div class="flex items-start mb-6 tm-menu-item">
                        <img src="img/menu-mie1.jpg" alt="Image" class="rounded-md">
                        <div class="ml-3 sm:ml-6">
                            <h3 class="text-lg sm:text-xl tm-text-yellow mb-1">Indomie</h3>
                            <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow">Mie goreng juga</h3>
                            <div class="text-white text-md sm:text-lg font-light">Rp.2000</div>
                        </div>                    
                    </div>
                </div>
                <div class="flex-1 m-5 rounded-xl px-4 py-6 sm:px-8 sm:py-10 tm-bg-brown tm-item-container">
                    <div class="flex items-start justify-end mb-6 tm-menu-item-2">
                        <div class="text-right mr-6">
                            <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow">Indomie</h3>
                            <div class="text-white text-md sm:text-lg font-light mb-1">mie Goweng</div>
                            <div class="text-white text-md sm:text-lg font-light">Rp.6000</div>
                        </div>
                        <img src="img/menu-mie1.jpg" alt="Image" class="rounded-md">                   
                    </div>
                    <div class="flex items-start justify-end mb-6 tm-menu-item-2">
                        <div class="text-right mr-6">
                            <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow">indomie</h3>
                            <div class="text-white text-md sm:text-lg font-light mb-1">mie goreng</div>
                            <div class="text-white text-md sm:text-lg font-light">Rp.5000</div>
                        </div>
                        <img src="img/menu-mie1.jpg" alt="Image" class="rounded-md">                    
                    </div>
                    <div class="flex items-start justify-end mb-6 tm-menu-item-2">
                        <div class="text-right mr-6">
                            <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow">Indomie</h3>
                            <div class="text-white text-md sm:text-lg font-light mb-1">Mie Goweng</div>
                            <div class="text-white text-md sm:text-lg font-light">Rp.10.000</div>
                        </div>   
                        <img src="img/menu-mie1.jpg" alt="Image" class="rounded-md">                 
                    </div>
                    <div class="flex items-start justify-end mb-6 tm-menu-item-2">                    
                        <div class="text-right mr-6">
                            <h3 class="text-lg sm:text-xl tm-text-yellow mb-1">Indomie</h3>
                            <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow">Mie Goweng</h3>
                            <div class="text-white text-md sm:text-lg font-light">Rp.10.000</div>
                        </div> 
                        <img src="img/menu-mie1.jpg" alt="Image" class="rounded-md">                   
                    </div>
...
document.getElementById('linkSpan').addEventListener('click', function() {
    window.location.href = 'http://localhost/2209106139_Muhammad%20Yusuf%20Efendi_POSTTEST5/login.php';
});
